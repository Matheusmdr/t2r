 ...
 * @see app/Http/Controllers/Admin/PostController.php:73
 ...
 * @see app/Http/Controllers/Admin/PostController.php:101
...
const PostController = { indexPublic, showPublic, index, create, store, edit, update, destroy }
